 ...
 */
final class IdealPaymentMethodProcessorPayment implements PaymentOrderRequestProcessorInterface
{
    public function process(OrderRequest $orderRequest, PaymentOrderRequestContext $context): void
    {
        unset($context);

        $orderRequest->payment_product = PluginPaymentProduct::IDEAL->value;
    }
}
