...
final class OneyShippingZipCodeValidator extends OneyZipCodeValidator
{
    protected string $message = 'sylius_hipay_plugin.checkout.oney.shipping_zipcode_invalid';
    ...
    public function getZipCode(OrderInterface $order): ?string
    {
