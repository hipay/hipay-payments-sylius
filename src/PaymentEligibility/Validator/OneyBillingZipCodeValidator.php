...
final class OneyBillingZipCodeValidator extends OneyZipCodeValidator
{
    protected string $message = 'sylius_hipay_plugin.checkout.oney.billing_zipcode_invalid';
